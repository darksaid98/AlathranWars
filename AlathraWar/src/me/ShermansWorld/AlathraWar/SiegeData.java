...
public class SiegeData
{
    ...
    public SiegeData(final Main plugin) {
    ...
    public void reloadConfig() {
        if (this.configFile == null) {
            this.configFile = new File(this.plugin.getDataFolder(), "sieges.yml");
        }
        this.dataConfig = (FileConfiguration)YamlConfiguration.loadConfiguration(this.configFile);
        final InputStream defaultStream = this.plugin.getResource("sieges.yml");
    ...
    public void saveDefaultConfig() {
        ...
        if (!this.configFile.exists()) {
            this.plugin.saveResource("sieges.yml", false);
        }
    }
}
