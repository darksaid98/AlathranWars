...
public class SiegeCommands implements CommandExecutor
{
    ...
    static {
        ...
        SiegeCommands.maxID = Main.data2.getConfig().getInt("MaxID");
    }
        ...
        if (args.length == 0) {
            ...
            if (args[0].equalsIgnoreCase("list")) {
                ...
                for (final Siege siege : SiegeCommands.sieges) {
                    ...
                    p.sendMessage("Time Left: " + String.valueOf((108000 - Main.data2.getConfig().getInt("Sieges." + String.valueOf(String.valueOf(siege.getID()) + ".siegeticks"))) / 1200) + " minutes");
                    p.sendMessage("-=-=-=-=-=-=-=-=-=-=-=-");
                }
            ...
            if (args[0].equalsIgnoreCase("stop")) {
                ...
                final String configOwner = Main.data2.getConfig().getString("Sieges." + args[1] + ".owner");
                    ...
                    if (war.getName().equalsIgnoreCase(args[1])) {
                        ...
                        for (final String entry : townyWorld.getTowns().keySet()) {
                            ...
                            if (town.getName().equalsIgnoreCase(args[2])) {
                                ...
                                ++SiegeCommands.maxID;
                                Main.data2.getConfig().set("MaxID", (Object)SiegeCommands.maxID);
                                ...
                                if (war.getSide1Players().contains(p.getName())) {
                                    ...
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".war", (Object)war.getName());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".town", (Object)town.getName());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".attackers", (Object)war.getSide1());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".defenders", (Object)war.getSide2());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".side1areattackers", (Object)true);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".side2areattackers", (Object)false);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".siegeticks", (Object)0);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".attackerpoints", (Object)0);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".defenderpoints", (Object)0);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".owner", (Object)p.getName());
                                    Main.data2.saveConfig();
                                }
                                else {
                                    ...
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".war", (Object)war.getName());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".town", (Object)town.getName());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".attackers", (Object)war.getSide2());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".defenders", (Object)war.getSide1());
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".side1areattackers", (Object)false);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".side2areattackers", (Object)true);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".siegeticks", (Object)0);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".attackerpoints", (Object)0);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".defenderpoints", (Object)0);
                                    Main.data2.getConfig().set("Sieges." + String.valueOf(SiegeCommands.maxID) + ".owner", (Object)p.getName());
