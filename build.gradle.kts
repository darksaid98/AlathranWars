...
plugins {
    ...
    id("org.flywaydb.flyway") version "11.13.2" // Database migrations
...
dependencies {
    ...
    library("org.flywaydb:flyway-core:11.13.2")
    library("org.flywaydb:flyway-mysql:11.13.2")
    ...
    testImplementation("org.flywaydb:flyway-mysql:11.13.2")
