...
public class Helper {
    ...
    public static void damageAllGear(Player p) {
        ...
        for (int i = 0; i < inv.getSize(); ++i) {
            ...
            if (is != null && (is.getType() == Material.NETHERITE_AXE || is.getType() == Material.NETHERITE_SWORD || is.getType() == Material.DIAMOND_AXE || is.getType() == Material.DIAMOND_SWORD || is.getType() == Material.IRON_AXE || is.getType() == Material.IRON_SWORD)) {
                final ItemMeta meta = getItemMeta(is);
                is.setItemMeta(meta);
            }
        }
        ...
        for (ItemStack itemStack : armor) {
            if (itemStack != null) {
                if (itemStack.getType() == Material.NETHERITE_HELMET || itemStack.getType() == Material.NETHERITE_CHESTPLATE || itemStack.getType() == Material.NETHERITE_LEGGINGS || itemStack.getType() == Material.NETHERITE_BOOTS || itemStack.getType() == Material.DIAMOND_HELMET || itemStack.getType() == Material.DIAMOND_CHESTPLATE || itemStack.getType() == Material.DIAMOND_LEGGINGS || itemStack.getType() == Material.NETHERITE_BOOTS || itemStack.getType() == Material.IRON_HELMET || itemStack.getType() == Material.IRON_CHESTPLATE || itemStack.getType() == Material.IRON_LEGGINGS || itemStack.getType() == Material.IRON_BOOTS) {
                    final ItemMeta meta2 = getItemMeta2(itemStack);
    ...
    @Nullable
    private static ItemMeta getItemMeta2(ItemStack is2) {
    ...
    @Nullable
    private static ItemMeta getItemMeta(ItemStack is) {
